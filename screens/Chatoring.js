...
const generateText = () => {
    ...
    //const apiKey = 'jwt: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjcGYiOiIwMzY4MDMxODYxOCIsImlhdCI6MTcxOTIzNTkzOCwiZXhwIjoxNzIxODI3OTM4fQ.94aHeobE0DSQ0RqkSs1YdQfL8JietxwMReUt_wQbszQ'; // Replace with your actual OpenAI API key


    fetch('https://api.openai.com/v1/chat/completions', {
    //fetch('https://apascentar-dev.onrender.com/chat', {
